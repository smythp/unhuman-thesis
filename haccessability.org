...
#+END_QUOTE
Though MySpace was a commercial platform and, in many or most respects, quite restrictive in use of the platform, it did encourage the development of skills that might be used to develop alternative spaces. Other systems, such as Apple's HyperCard, had a similar influence, and the web abounds with stories of those who learned computers, or programming, in this manner.
...
, seeding systems in which participants have agency can preempt exploitative development. 
