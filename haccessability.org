...
To resist, engage, or even conceptualize something as overwhelming as our theorized Abstraction requires a specific cast of mind. In /The Principle of Hope/, Ernst Bloch observes in in a process of continuous becoming, that "much in the world is still unclosed."
...
#+END_QUOTE
To see the system and to step outside it in the imagination is, as suggested by Laing's account of the traveler to the past and future, a form of madness. To envision ways to carve out a space for ourselves or for our community, we must be mad enough to leave it, but realistic enough to come back.


 seek to change it is, Laing's



In the ten-day voyage of the sailor into the




It is a system, and systems have weaknesses.


the hacker leverages hyperlocal knowledge—the obscure bug, the misconfigured server, the unanticipated input—
...
have hope
to have hope is to be crazy
hacking is a kind of frazy
...
To stand in resistance to something like the Abstraction is a kind of perversity
...
A given individuals contribution has never been so meaningless. And yet the specific contributuion, the one that makes a difference, has never been so meaningful.
 ...
 Your little hack, shared, might shame a gatekeeper, or inspire another.
