...
in terms of identity, there is no Christy Brown 


There exists no life and identity for that non-author.



 Autobiography is an uncomfortable act of self-creation. But, just as re

But an autobiography can also create something out of nothing.

 There is something unstable in all this—
...
*************** TODO try to get this joke working if I have time
*************** END


# END FOOTNOTE !!!

*************** TODO will probably need to define a dicionary entry for the bibliography
*************** END
