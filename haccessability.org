...
A thread underlying these criticisms is a concern for cachet, reputation, and intellectual capital that becomes pathological in a time of scarcity and precarity. Jan Parker alludes to this in a discussion of a student protest that led to an nine-day occupationK:
...
As Parker suggests, while the sciences struggle with issues of accessibility and exclusivity, there is a countervailing tradition of engagement with the public that facilitates broader understanding of the importance of science. A humanities tradition of engagement with the public is significantly less developed. Though a subtler, this lack of engagement with the public, combined with the dwindling resources directed at the humanities, causes suspicion to be levied at boundary 


In the following section, we will explore some of the differences between how the humanities and the sciences share research and engage the public.
...
digital humanities too big
digital humanities razzmatazz





maybe we should stop talking about the digital humanities like it's a bunch of razzmatazz. let's do boring work




There are a number of conflations here—technology with the future, 
...
xxx USE PARKER FROM 21st CENTURY BOOK HERE?
