...
[fn:infinity-mirror] An infinity mirror is a set of two (or more) mirrors that, in concert, create the effect of reflections receding to infinity. We'll return to this image to elaborate it more fuly later in the chapter.
